...
function template_main()
{
	...
	<div id="newsfader">
		...
		<div class="description"><ul class="reset" id="smfFadeScroller"', empty($options['collapse_news_fader']) ? '' : ' style="display: none;"', '>';
	...
	echo '
	<div class="boardstyle_index"><div id="boardindex_table">
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				echo '
						...
						<p class="t_description">', $board['description'] , '</p>';
